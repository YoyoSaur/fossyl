...
With Zod, wrap your schemas using `zodValidator` from `@fossyl/zod`:

```typescript code-project="regression" code-file="features/todos/validators/todos.validators.ts" tag="todo-schemas"
```

```typescript code-project="regression" code-file="features/todos/validators/todos.validators.ts" tag="todo-validators"
```
...
```typescript code-project="regression" code-file="index.ts" tag="app-bootstrap"
```
